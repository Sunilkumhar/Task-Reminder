  ...
  return (
    ...
    {errmsg !== ""?(
      <div className=" row errormsg">
        ...
        <p className = "col-1 remove" onClick = {removeErr}>X</p>
      </div>
    ):null} 
      ...
      <div className="container1">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="row1">
            <div className="form-group pass">
              ...
              <div className="passwordregister">
                ...
                <div className="eyeR">
                  {
                    eyeiconP === "VisibilityOffIcon"?<VisibilityOffIcon onClick = {changeVisibilityOffP}/>:<VisibilityIcon onClick = {changeVisibilityP}/>
                  }
                </div>
              </div>
            </div>
          ...
          <div className="row1">
            <div className="form-group cpass">
              ...
              <div className="passwordregister">
                ...
                <div className="eyeR">
                  {
                    eyeiconCp === "VisibilityOffIcon"?<VisibilityOffIcon onClick = {changeVisibilityOffCp}/>:<VisibilityIcon onClick = {changeVisibilityCp}/>
                  }
                </div>
              </div>
            </div>
          ...
          <div className="form-check">
            ...
            />
            <label className="form-check-label" htmlFor="exampleCheck1" onChange={handleAgree}>
